...
export const SYSTEM_ACCOUNTS: ReadonlyArray<{
  ...
  { type: 'PARTNER_RECEIVABLE', currency: 'RUB', partition: 'NEUTRAL', scope: 'PAYIN_RU' },
  { type: 'PARTNER_RECEIVABLE', currency: 'NGN', partition: 'NEUTRAL', scope: 'PAYOUT_NG' },
  { type: 'PARTNER_RECEIVABLE', currency: 'GHS', partition: 'NEUTRAL', scope: 'PAYOUT_GH' },
